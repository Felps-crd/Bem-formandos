...
<body>
    <div class="container-principal">
        ...
        <header>
            ...
            <a href="tela-adm-vest.html"><span class="material-symbols-outlined">home</span></a>
        ...
        <main>
            ...
            <!--Cards rows de vestibulares e funcionarios-->
            ...
            <div class="content-box">
                ...
                <div class="card">
                  <div class="card-left">
                    ...
                    <div class="info">
                      <h3>USP</h3>
                      <p>FUVEST &nbsp;&nbsp; Inscrições: dia-mes-ano &nbsp;&nbsp; Prova: dia-mes-ano &nbsp;&nbsp; R$ 211,00</p>
                    </div>
                  </div>
                  <div class="card-right">
                    <button class="btn-icon edit abrir-modal" data-id="1"><i class="fa-regular fa-pen-to-square"></i></button>
                ...
                <div class="card">
                  <div class="card-left">
                    ...
                    <div class="info">
                      <h3>UNICAMP</h3>
                      <p>Vestibular Próprio &nbsp;&nbsp; Inscrições: dia-mes-ano &nbsp;&nbsp; Prova: dia-mes-ano &nbsp;&nbsp; R$ 150,00</p>
                    </div>
                  </div>
                  <div class="card-right">
                    <button class="btn-icon edit abrir-modal" data-id="1"><i class="fa-regular fa-pen-to-square"></i></button>
