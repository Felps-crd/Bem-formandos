...
<head>
    ...
    <title>Calendário Fatec | Bem Formandos</title>
...
.area-card {
    background: #fff;
    border: 1.8px solid rgb(232, 204, 204);
        ...
        <main class="main-vestibulares">
            ...
            <div class="conteudo">
               ...
               <section id="cronograma">
                <h2>Cronograma 1° Semestre 2026</h2>
                ...
                <div class="area-cards area-cards--info">
                    <div class="cards card--info">
                        <div class="conteudo-card">
                            <span class="icone-info icone-info--fatec"><i class="bi bi-alarm-fill"></i></span>
                            <h3 class="titulo-info">Prazos e Horários</h3>
                            <ul class="lista-dados" style="color: #2f3847;">
                                <li>Inscrições encerram pontualmente às 15h.</li>
                    ...
                    <div class="cards card--info">
                         <div class="conteudo-card">
                            <span class="icone-info icone-info--fatec"><i class="bi bi-file-text-fill"></i></span>
            ...
            <aside class="painel-lateral">
                <div class="card">
                    ...
                    <hr>
                        <ul>
                        <li><a href="#introducao">Cronograma 1° Semestre 2026</a></li>
