<?php
$menu_items = [
     'home-fatec.php' => ['label' => 'O que é','icon' => 'bi bi-info-circle-fill'],
...
$sidebar_title = $sidebar_title ?? 'FATEC'; 
?>

<nav id="sidebar" class="sidebar sidebar--fatec" aria-label="Menu <?php echo htmlspecialchars($sidebar_title); ?>">
