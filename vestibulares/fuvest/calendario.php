...
<head>
    ...
    <title>Calendário Fuvest | Bem Formandos</title>
    <style>
       /* === CARD DO GRUPO === */

.area-card {
    background: #fff;
    border: 1.8px solid rgb(232, 223, 204);
    border-left: 5px solid #E99117;
    border-radius: 10px;
    padding: 20px 25px;
    margin-bottom: 25px;
        ...
        <main class="main-vestibulares">
            ...
            <div class="conteudo">
                <section id="introducao">
                    <h1 class="titulo titulo--fuvest"><i class="bi bi-calendar-fill"></i>CALENDÁRIO</h1>
                    <hr>
                    <p>Fique por dentro de todas as datas importantes do FUVEST 2026. Aqui você encontra o cronograma oficial completo com prazos de inscrição, datas das provas, simulado e divulgação dos resultados.</p>
                </section>

                <section id="cronograma">
                <h2>Cronograma Completo Fuvest <?php echo date('Y');?></h2>
                ...
                <div class="area-cards area-cards--info">
                    <div class="cards card--info">
                        <div class="conteudo-card">
                            <span class="icone-info icone-info--fuvest"><i class="bi bi-alarm-fill"></i></span>
                            <h3 class="titulo-info">Prazos e Horários</h3>
                            <ul class="lista-dados" style="color: #2f3847;">
                                <li>Inscrições encerram pontualmente às 12h.</li>
                    ...
                    <div class="cards card--info">
                         <div class="conteudo-card">
                            <span class="icone-info icone-info--fuvest"><i class="bi bi-file-text-fill"></i></span>
            ...
            <aside class="painel-lateral">
                <div class="card">
                    ...
                    <hr>
                        <ul>
                            <li><a href="#introducao">Cronograma Fuvest <?php echo date('Y');?></a></li>
