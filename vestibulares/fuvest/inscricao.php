...
<head>
    ...
    <title>Inscrição | Bem Formandos</title>
</head>
<body>
        ...
        <main class="main-vestibulares">
            ...
            <div class="conteudo">
                <section id="introducao">
                    ...
                    <hr>
                    <p>O processo de inscrição para o vestibular Fuvest e totalmente online e deve ser realizado através do site oficial. Siga o passo a passo abaixo para realizar sua inscrição.</p>
                </section>
                <div class="infos-importantes infos-importantes--fuvest">
                    <div class="conteudo-infos-importantes">
                        <div class="header-infos-importantes header-infos-importantes--fuvest">
                            <i class="bi bi-info-circle-fill"></i>
                            <strong class="titulo-infos-importantes titulo-infos-importantes--fuvest">Informações Importantes</strong>
                        </div>

                        <p class="texto-infos-importantes texto-infos-importantes--fuvest">
                            <strong class="destaque-texto-infos-importantes destaque-texto-infos-importantes--fuvest">Período de inscrições:</strong>
                            <?= htmlspecialchars($periodo_inscricoes ?? 'A definir'); ?>
                        </p>

                        <p class="texto-infos-importantes texto-infos-importantes--fuvest">
                            <strong class="destaque-texto-infos-importantes destaque-texto-infos-importantes--fuvest">Taxa de inscrição:</strong>
                            R$ <?= htmlspecialchars($taxa ?? '0,00'); ?>
                        </p>

                        <p class="texto-infos-importantes texto-infos-importantes--fuvest">
                            <strong class="destaque-texto-infos-importantes destaque-texto-infos-importantes--fuvest">Site oficial:</strong>
                    ...
                    <div class="area-cards area-cards--requisitos">
                        <div class="cards card--requisito">
                            <div class="conteudo-card">
                                <span class="icone-info icone-info--fuvest"><i class="bi bi-person-vcard-fill"></i></span>
                        ...
                        <div class="cards card--requisito">
                            <div class="conteudo-card">
                                <span class="icone-info icone-info--fuvest"><i class="bi bi-mortarboard-fill"></i></span>
                        ...
                        <div class="cards card--requisito">
                            <div class="conteudo-card">
                                <span class="icone-info icone-info--fuvest"><i class="bi bi-telephone-fill"></i></span>
                        ...
                        <div class="cards card--requisito">
                            <div class="conteudo-card">
                                <span class="icone-info icone-info--fuvest"><i class="bi bi-credit-card-fill"></i></span>
                ...
                <section id="passo-a-passo">
                    ...
                    <div class="area-cards">
                        <div class="card-passo">
                            ...
                            <p class="texto-card-passo">Entre no site oficial da Fuvest: <strong><a class="link-fuvest" href="https://www.fuvest.br">www.fuvest.br</a></strong></p>
                        ...
                        <div class="card-passo">
                            <div class="header-passo">
                                <span class="dot dot--fuvest">4</span>
                                <h3 class="titulo-card-passo">Escolha os Cursos e Carreiras</h3>
                            </div>
                            <p class="texto-card-passo">Selecione até 4 opções de curso em ordem de preferência</p>
                            <p class="texto-card-passo">Consulte o Guia de Carreiras para conhecer todos os cursos disponíveis e suas especificidades</p>
                        </div>
                        <div class="card-passo">
                            <div class="header-passo">
                                <span class="dot dot--fuvest">5</span>
                            ...
                            <div class="card-info card-info--fuvest">
                                <div class="conteudo-card-info">
                                    <i class="bi bi-info-circle-fill"></i>
                                    <p class="texto-card-info texto-card-info--fuvest">Você precisará enviar a documentação comprobatória</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-passo">
                            <div class="header-passo">
                                <span class="dot dot--fuvest">6</span>
                            ...
                            <div class="card-info card-info--fuvest">
                                <div class="conteudo-card-info">
                                    ...
                                    <p class="texto-card-info texto-card-info--fuvest">Após confirmar, alguns dados não poderão ser alterados</p>
                                </div>
                            </div>
                        </div>
                        <div class="card-passo">
                            <div class="header-passo">
                                <span class="dot dot--fuvest">7</span>
                        ...
                        <div class="card-passo">
                            <div class="header-passo">
                                <span class="dot dot--fuvest">8</span>
                            ...
                            <div class="card-info card-info--fuvest">
                                <div class="conteudo-card-info">
                                    ...
                                    <p class="texto-card-info texto-card-info--fuvest">Guarde o comprovante de pagamento</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="isencao">
                    ...
                    <div class="solicita">
                        ...
                        <ul class="lista-isencao">
                            ...
                            <li class="item-lista-isencao">Candidatos que cursaram integralmente o ensino médio em escolas públicas</li>
                    ...
                    <div class="solicita">
                        ...
                        <ul class="lista-isencao">
                            <li class="item-lista-isencao">Candidatos que cursaram integralmente o ensino médio em escolas públicas</li>
                            <li class="item-lista-isencao">Candidatos com renda familiar per capita superior a 1,5 e igual ou inferior a 3 salários mínimos</li>
                        </ul>
                    </div>
                    <hr class="linha-isencao">
                    ...
                    <div class="solicita">
                        ...
                        <ol class="lista-isencao">
                            <li class="item-lista-isencao">Acesse o site oficial da Fuvest no período específico</li>
                            <li class="item-lista-isencao">Clique em “Redução de Taxa”</li>
            ...
            <aside class="painel-lateral">
                ...
                <div class="card">
                    ...
                    <h4>Calendário Fuvest</h4>
                        ...
                        <div class="ler-mais ler-mais--fuvest"><a href="calendario.php">Ler mais</a></div>
                        <hr>
