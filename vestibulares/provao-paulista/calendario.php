...
<head>
    ...
    <title>Calendário Provão Paulista | Bem Formandos</title>
    <style>
       /* === CARD DO GRUPO === */

.area-card {
    background: #fff;
    border: 1.8px solid rgb(204, 211, 232);
                ...
                <div class="area-cards area-cards--info">
                    <div class="cards card--info">
                        <div class="conteudo-card">
                            <span class="icone-info icone-info--provao"><i class="bi bi-alarm-fill"></i></span>
                            <h3 class="titulo-info">Horários</h3>
                            <ul class="lista-dados" style="color: #2f3847;">
                                <li>Os portões fecham pontualmente.</li>
                                <li>Chegue com antecendencia.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="cards card--info">
                         <div class="conteudo-card">
                            <span class="icone-info icone-info--provao"><i class="bi bi-person-vcard-fill"></i></span>
                            <h3 class="titulo-info">Documentos</h3>
                            <p class="texto-info">Confira os documentos necessários para realizar a prova com antecedência.</p>
                         </div>    
                    </div>
                    <div class="cards card--info">
                         <div class="conteudo-card">
                            <span class="icone-info icone-info--provao"><i class="bi bi-file-text-fill"></i></span>
