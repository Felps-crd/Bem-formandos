<?php
$menu_items = [
     'home-unicamp.php' => ['label' => 'O que é','icon' => 'bi bi-info-circle-fill'],
...
$sidebar_title = $sidebar_title ?? 'UNICAMP'; 
?>

<nav id="sidebar" class="sidebar sidebar--unicamp" aria-label="Menu <?php echo htmlspecialchars($sidebar_title); ?>">
