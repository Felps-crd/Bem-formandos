...
<head>
    ...
    <title>Calendário Unicamp | Bem Formandos</title>
    <style>
       /* === CARD DO GRUPO === */

.area-card {
    background: #fff;
    border: 1.8px solid rgb(223, 204, 232);
    border-left: 5px solid #8c29d8;
    border-radius: 10px;
    padding: 20px 25px;
    margin-bottom: 25px;
                ...
                <div class="area-cards area-cards--info">
                    <div class="cards card--info">
                        <div class="conteudo-card">
                            <span class="icone-info icone-info--unicamp"><i class="bi bi-alarm-fill"></i></span>
                    ...
                    <div class="cards card--info">
                         <div class="conteudo-card">
                            <span class="icone-info icone-info--unicamp"><i class="bi bi-file-text-fill"></i></span>
